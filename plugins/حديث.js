  ...
  try {
    ...
    for (let result of selectedResults) {
      results.push({
        ...
        footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "ₛₐfᵣₒₜ↯bₒₜ" }), // ضع العلامة المائية هنا
      ...
      viewOnceMessage: {
        message: {
          ...
          interactiveMessage: proto.Message.InteractiveMessage.fromObject({
            body: proto.Message.InteractiveMessage.Body.create({ text: 'نتائج البحث 🧚🏼‍♂️' + searchQuery }),
