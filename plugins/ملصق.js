...
else return m.reply('*عنوان URL / الرابط غير صالح ، يجب أن يكون إنهاء الرابط / URL / الرابط هو ‏jpg ، على سبيل المثال .ملصق https://i.ibb.co/jJ6fJ4k/file.jpg*')
...
else throw '> *\`『 اعمل ريب ع الصوره الي هتحولها ملصق 🧚🏻‍♂️ 』\`*'
