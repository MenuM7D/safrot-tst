...
handler.before = async function (m) {
    ...
    if (m.quoted.id == this.tekateki[id][0].id) {
        ...
        if (m.text.toLowerCase() == json.response.toLowerCase().trim()) {
            ...
            m.reply(`
╮───────────────────────╭ـ
│ 👏🏻 *أحسنت لقد فزت إجابتك صحيحة 🧚🏻‍♂️*
│ 💰 *جائزتـك : ❲ ${this.tekateki[id][2]} ❳ نقطه 🧚🏻‍♂️*
╯───────────────────────╰ـ`.trim())
            ...
            m.reply(`
╮───────────────────────╭ـ
│ 😒 *يالك من فاشل لقد انسحبت 🧚🏻‍♂️*
│ 💰 *الخسـارة : ❲ ${this.tekateki[id][2]} ❳ نقطه 🧚🏻‍♂️*
╯───────────────────────╰ـ`.trim())
            clearTimeout(this.tekateki[id][3])
            delete this.tekateki[id]
        ...
        m.reply(`
╮───────────────────────╭ـ
│ 😒 *يالك من فاشل لا تستطيع الإجابة بمفردك 🧚🏻‍♂️*
│ ❗ *الاجـابة : ❲ ${answer} ❳ 🧚🏻‍♂️*
╯───────────────────────╰ـ`.trim())          
