...
export async function before(m, { conn }) {
    ...
    if (before !== user.level) {
        conn.reply(m.chat, [`*「 مبروك! وصلت للمستوى الجديد 🆙🧚🏼‍♂️ 」* \n\n*مبروك، ارتفعت لمستوى جديد! استمر كده 🧚🏼‍♂️*\n\n*المستوى:* ${before} ⟿ ${user.level}\n* الرتبة ${user.role}*\n\n*عشان تشوف XP بتاعك في الوقت الحقيقي استخدم الأمر #level`, `@${m.sender.split`@`[0]} أوه، وصلت للمستوى التالي*\n*• المستوى ${before} ⟿ ${user.level}\n\n_*عشان تشوف مين في التوب استخدم الأمر* #lb`, `يا سلام @${m.sender.split`@`[0]}، وصلت لمستوى جديد 🙌*\n\n*• المستوى الجديد:* ${user.level}\n*• المستوى السابق:* ${before}\n`].getRandom(), m, {contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: wm, body: ' *سفروت بوت🧚🏼‍♂️* ', previewType: 0, thumbnail: img.getRandom(), sourceUrl: redes.getRandom()}}})
    }
}
