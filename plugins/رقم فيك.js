...
let handler = async (m, { conn, text, command, usedPrefix }) => {
    ...
    if (feature === "دولة") {
        ...
        try {
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, '𝙎𝙖𝙛𝙧𝙤𝙩𝘽𝙤𝙩', pp, [['حاول مجددا',`${usedPrefix + command} أرقام ${additionalLink}`]], null, null, m);
        }
        ...
        try {
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, '𝙎𝙖𝙛𝙧𝙤𝙩-𝘽𝙤𝙩', pp, [['حاول مجددا',`${usedPrefix + command} رسائل ${additionalLink}`]], null, null, m);
        }
    } else if (feature === "كود") {
        if (!additionalLink) {
        ...
        try {
            ...
            console.log(error);
            return conn.sendButton(m.chat, `╮────────────────────────╭ـ\n│ حدث خطأ أثناء جلب البيانات. حاول مرة أخرى لاحقًا.\n╯────────────────────────╰ـ `, '𝙎𝙖𝙛𝙧𝙤𝙩-𝘽𝙤𝙩', pp, [['حاول مجددا',`${usedPrefix + command} كود ${additionalLink}`]], null, null, m);
        }
    }
};
